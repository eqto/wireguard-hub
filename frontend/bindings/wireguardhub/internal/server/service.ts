...
export function GetClient(serverID: string): $CancellablePromise<ssh$0.Executor> {
    return $Call.ByID(1502784386, serverID);
}

export function GetLocalConfig(): $CancellablePromise<models$0.LocalConfig> {
    return $Call.ByID(383668778);
}
...
export function SaveLocalConfig(cfg: models$0.LocalConfig): $CancellablePromise<boolean> {
    return $Call.ByID(771587187, cfg);
}

export function SetLocalSessionCredentials(username: string, password: string): $CancellablePromise<boolean> {
